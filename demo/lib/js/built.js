...
description: Class to collapse page sections by clicking an element.
...
provides: [Collapsible, Collapsible.Header]

authors: [Carson S. Christian](mailto:cscade@gmail.com)
...
Collapsible.Header = new Class({
	Extends: Collapsible,
	initialize: function (clicker, section, options) {
		// Same functionality as Collapsible, but includes mouseover hint and descriptive text on clicker.
		if (clicker) {
		...
		this.parent(clicker, section, options);
	}
});
